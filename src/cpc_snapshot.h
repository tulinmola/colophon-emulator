/*
 * cpc_snapshot.h — the CPC's SNA snapshot format, read and written.
 *
 ...
 */
#ifndef COLOPHON_CPC_SNAPSHOT_H
#define COLOPHON_CPC_SNAPSHOT_H
...
#define CPC_SNAPSHOT_HEADER_SIZE 256
